...
<video autoplay muted loop class="myVideo">
    <source src="./img/Atoms - 8579.mp4.mp4" type="video/mp4">
</video>
...
<div style="width: 40rem; height:45rem" class="formsection">
    ...
    <form style="width: 75%;" action="BillFormServlet" method="post">
        <div class="formcol">
            ...
            <input style="padding: 0.3rem; margin-bottom: 1rem; border-radius: 0.4rem;" name="user_name" required type="text" class="form-control" value="<%=user.getUserName()%>" placeholder="Enter Name">
        ...
        <div class="formcol">
            ...
            <input style="padding: 0.3rem; margin-bottom: 1rem; border-radius: 0.4rem;" name="user_address" required type="text" class="form-control" value="<%=user.getUserAddress()%>" placeholder="Enter Password">
        ...
        <div class="formcol">
            ...
            <input style="padding: 0.3rem; margin-bottom: 1rem; border-radius: 0.4rem;" name="units" required class="form-control" type="text" placeholder="Enter Unit Consumed">
        ...
        <div class="formcol">
            ...
            <input style="padding: 0.3rem; margin-bottom: 1rem; border-radius: 0.4rem;" name="dues" required class="form-control" type="text" placeholder="Enter Any Dues">
