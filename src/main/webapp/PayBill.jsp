...
<form action="PayBillServlet" method="post">
    <div class="container">
        <div class="card-body f1">
            ...
            <h2 class="text-center my-3"><strong>Pay <%=user.getBoardType().toUpperCase()%> Bill</strong></h2>
            ...
            <p class="card-text">Enter Due Amount<br><input type="text" placeholder="Enter <%=bill.getDues()%>" name="due" required class="form-control"></p>
            <p class="card-text">Enter Bill Amount<br><input type="text" placeholder="Enter <%=bill.getAmount()%>" name="billA" required class="form-control"></p>
