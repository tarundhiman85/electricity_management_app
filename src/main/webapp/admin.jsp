...
<div style="top:18rem" class="servicesection">
    <div id="cardfirst" class="card1">
        ...
        <div class="cardbody">
            <a href="register.jsp">
                <button class="cardbtn">Add New Connection</button>
            </a>
        </div>
    </div>
    <div id="cardsecond" class="card1">
        ...
        <div class="cardbody">
            <a href="viewUser.jsp">
                <button class="cardbtn">View User</button>
            </a>
        </div>
    </div>
    <div id="cardthird" class="card1">
        ...
        <div class="cardbody">
            <a href="editUser.jsp?user_id=<%=user1.getUserId()%>">
                <button class="cardbtn">Update Profile</button>
            </a>
        </div>
    </div>
    <div id="cardfourth" class="card1">
        ...
        <div class="cardbody">
            <a href="calculateBill.jsp">
                <button class="cardbtn">Calculate Bill</button>
            </a>
        </div>
    </div>
    <div id="cardfive" class="card1">
        ...
        <div class="cardbody">
            <a href="ResolveIsue.jsp">
                <button class="cardbtn">View & Resolve Issue</button>
            </a>
        </div>
    </div>
    <div id="cardsix" class="card1">
        ...
        <div class="cardbody">
            <a href="viewConnRequests.jsp">
                <button style="width: 16rem" class="cardbtn">View Connection Requests</button>
            </a>
        </div>
    </div>
</div>
